(function () {
	...
	$(document).ready(function () {
		...
		$("input:radio[name=menu-dropdown-icon]").change(function () {
			...
			const dropdownIconValue = $("input:radio[name=menu-dropdown-icon]:checked").val();
			if (dropdownIconValue) {
				newClass1.push(dropdownIconValue.toLowerCase().replace(/\s+/, "-"));
			}

			const listIconValue = $("input:radio[name=menu-list-icon]:checked").val();
			if (listIconValue) {
				newClass1.push(listIconValue.toLowerCase().replace(/\s+/, "-"));
			}
